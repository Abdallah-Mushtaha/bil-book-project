      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            ...
            >
              Discover practical insights for building healthier, stronger, and
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-8 text-center">
          ...
          <div className="space-y-1">
            ...
            >
              Demo project created for portfolio purposes. All names, images,
              and content are used for demonstration only.
            </p>
          </div>
        </div>
      </footer>
